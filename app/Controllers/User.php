...
class User extends BaseController
{
    ...
    private $rules = [
        ...
        'username' => ['rules' => 'required|alpha_numeric|is_unique[tb_users.username,id,{id}]', 'errors' => ['required' => 'Username Wajib Di Isi', 'is_unique' => 'username telah terdaftar']],
        'email'    => ['rules' => 'required|valid_email|is_unique[tb_users.email,id,{id}]', 'errors' => ['required' => 'email Wajib Di Isi', 'is_unique' => 'email telah terdaftar']],
